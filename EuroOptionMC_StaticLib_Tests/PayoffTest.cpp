...
#include "ConvergenceTable.h" // Include the ConvergenceTable class definition.
#include "IncludeParameter.h" // Include the Parameter classes.
...
namespace parameters
{
	...
	public:
		...
		{
			double constant = 1.0; // The constant value to be used in the parameters_constant object.
